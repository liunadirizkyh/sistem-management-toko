                        ...
                        <form action="{{ route('dashboard') }}" method="GET" class="space-y-6">
                            <div>
                                ...
                                <div class="flex rounded-md shadow-sm overflow-hidden">
                                    <input type="radio" name="filter_type" id="daily" value="daily" class="sr-only peer/daily" {{ $selectedFilterType == 'daily' ? 'checked' : '' }}>
                                    <label for="daily" class="flex-1 text-center px-4 py-2 text-sm cursor-pointer border border-gray-300 font-medium text-gray-600 hover:bg-gray-50 peer-checked/daily:bg-blue-500 peer-checked/daily:text-white peer-checked/daily:border-blue-500">
                                        Harian
                                    </label>
                                    <input type="radio" name="filter_type" id="monthly" value="monthly" class="sr-only peer/monthly" {{ $selectedFilterType == 'monthly' ? 'checked' : '' }}>
                                    <label for="monthly" class="flex-1 text-center px-4 py-2 text-sm cursor-pointer border border-gray-300 font-medium text-gray-600 hover:bg-gray-50 peer-checked/monthly:bg-blue-500 peer-checked/monthly:text-white peer-checked/monthly:border-blue-500">
                                        Bulanan
                                    </label>
                                    <input type="radio" name="filter_type" id="yearly" value="yearly" class="sr-only peer/yearly" {{ $selectedFilterType == 'yearly' ? 'checked' : '' }}>
                                    <label for="yearly" class="flex-1 text-center px-4 py-2 text-sm cursor-pointer border border-gray-300 font-medium text-gray-600 hover:bg-gray-50 peer-checked/yearly:bg-blue-500 peer-checked/yearly:text-white peer-checked/yearly:border-blue-500">
                                        Tahunan
                                    </label>
                                </div>
                            </div>
                            <div id="day-selector">
                                ...
                                <select name="day" id="day" class="mt-1 w-full rounded-md shadow-sm border-gray-300">
                                    @for ($i = 1; $i <= 31; $i++)
                            ...
                            <div id="month-selector">
                                ...
                                <select name="month" id="month" class="mt-1 w-full rounded-md shadow-sm border-gray-300">
                                    @for ($i = 1; $i <= 12; $i++)
                            ...
                            <div>
                                ...
                                <select name="year" id="year" class="mt-1 w-full rounded-md shadow-sm border-gray-300">
            ...
            @else
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h3 class="text-xl font-semibold">Selamat Datang di Sistem Penjualan</h3>
                        <p class="mt-2 text-gray-600">Silakan pilih menu di atas untuk melanjutkan.</p>
                    </div>
                </div>
            @endrole
