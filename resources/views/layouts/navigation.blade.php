<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('admin')
                <x-responsive-nav-link :href="route('kode-barang.index')" :active="request()->routeIs('kode-barang.*')">
                    {{ __('Kode Barang') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('hutang-supplier.index')" :active="request()->routeIs('hutang-supplier.*')">
                    {{ __('Hutang Supplier') }}
                </x-responsive-nav-link>
            @endrole
        </div>
